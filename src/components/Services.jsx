function Services() {
  return (
    <div className="grid lg:grid-cols-2 grid-cols-1">
      ...
      <div className="lg:bg-[url('/images/desktop/image-graphic-design.jpg')] bg-[url('/images/mobile/image-graphic-design.jpg')] bg-no-repeat bg-contain lg:py-[300px] py-[300px] flex flex-col justify-end items-center relative">
      ...
      <div className="lg:bg-[url('/images/desktop/image-photography.jpg')] bg-[url('/images/mobile/image-photography.jpg')] bg-no-repeat bg-contain lg:py-[300px] py-[300px] flex flex-col justify-end items-center relative">
